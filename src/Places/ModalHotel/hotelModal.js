...
const Modal = (props) => {
    const { modalCont, modal, handleClose , modalPic, t } = props;
            ...
            <div className={`${s.conteners} ${r.conteners}`}>
                <div className={`${s.modalC} ${r.modalC}`}>
                    <div >
                       ...
                       <h2> {t(`hotel.${modalCont.id}.name`)} </h2>
                    </div>
