...
const Sport = (props) => {
    ...
    return (
        <div className="super_container">
            ...
            <HomeOne src={obj.src} name={t('sports.name')} />
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-xl-5 col-lg-6">
                                                        <div className="blog_post_content">
                                                            ...
                                                            <div className="pb_title"><a href="#">{t(`sport.${item.id}.name`)} </a></div>
                                                            <div className="pb_text" >
                                                                <p> {t('descriptionMix.address')}: {t(`sport.${item.id}.address`)}</p>
                                                                <p> {t('descriptionMix.WorkingTime')}:  {t(`sport.${item.id}.time`)}</p>
                                                                <p> {t('descriptionMix.phone')}: {t(`sport.${item.id}.phone`)}</p>
